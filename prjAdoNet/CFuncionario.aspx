                    ...
                    <div class="card efeito_Card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <asp:Button ID="cmdConfirmar" runat="server" Text="Incluir" Width="100%" CssClass="form-control btn btn-outline-primary" />
                                    </div>
                                    <div class="col-md-3">
                                        <asp:Button ID="cmdExcluir" runat="server" Text="Excluir" Width="100%" CssClass="form-control btn btn-outline-primary" />
                                    </div>
                                    <div class="col-md-3">
                                        <asp:Button ID="cmdLimpar" runat="server" Text="Limpar" Width="100%" CssClass="form-control btn btn-outline-primary" />
                                    </div>
                                    <div class="col-md-3">
                                        <asp:Button ID="cmdSair" runat="server" Text="Sair" Width="100%" CssClass="form-control btn btn-outline-primary" />
                                    </div>
                                </div>
                            </div>
                        </div>
